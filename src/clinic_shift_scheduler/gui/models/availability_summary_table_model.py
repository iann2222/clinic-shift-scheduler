...
class AvailabilitySummaryTableModel(QAbstractTableModel):
    ...
    def selected_periods(self, employee: EmployeeDraft) -> set[tuple[date, Period]]:
    ...
    def replace_selected_periods(
        ...
        if self._employment_type is EmploymentType.FULL_TIME:
            ...
            self._draft.replace_part_time_available_periods(employee, selected)
    ...
    def data(
        ...
        if role == Qt.ItemDataRole.DisplayRole:
            ...
            return _format_periods(self.selected_periods(employee))
